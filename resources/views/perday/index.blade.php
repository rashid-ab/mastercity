...
<select class="form-control forms_selection" style="width: 150px;" >
    <option  value="Perday-Form" >Perday Form</option>
     <option  value="Party-Form" >Party Form</option>
      <option  value="Thekedar-Form">Thekedar Form</option>
      <option  value="Office-Form">Office Form</option>
...
<datalist id="items" >
  ...
  @endforeach
        ...
        <div class="form-group">
            <input placeholder="Party Name" name='client_name'  class="form-control item" autocomplete="off" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control donation" value="5" name="donation" placeholder="Donation" >
        </div>
        <div class="form-group">
            <input type="text" class="form-control reason" name="reason" placeholder="Reason" >
        </div>  
        <div class="form-group">
            <input type="text" class="form-control feedback" name="feedback" placeholder="Feed Back" >
        </div>      
      <div class="form-group">
            <input type="date" class="form-control pricee datee" name="date" placeholder="Date"  required>
        </div> 
        <div class="form-group">
